...
- 保留 Color Queens 的 Queen 逻辑玩法，不改成倒水或三消
- 启动后进入休闲闯关首页，参考 Royal Match / Magic Sort 的资源栏、主视觉和开始关卡布局
- 首页增加金币、生命、庭院章节进度、每日奖励、宝箱和底部导航入口
...
- 更新冒烟测试，覆盖 50 关数据结构、答案合法性和唯一解检查
...
- 撤销、清除、教学提示、通关奖励与下一关
- 教学提示会高亮候选格并解释行、列、颜色区域或相邻限制，不会直接替玩家放置皇冠
